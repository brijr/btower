...
export default function Intro() {
	return (
		<div>
			<div className="mt-24 mb-24 xl:mb-64">
				...
				<h1 className="text-4xl">
					...
					<small className="block">
						...
						, and{' '}
						<a href="https://youtube.com/@code-craft" target="_blank" rel="noreferrer">
							CodeCraft
						</a>
					</small>
				</h1>
				<h2 className="text-xl">
					Frontend Developer, Multi-Disciplinary Designer, and Product Marketer located in{' '}
					<a href="https://goo.gl/maps/u25hR137vAGcUXtP9" target="_blank" rel="noreferrer">
						Salt Lake City
					</a>
			...
			<p>
				I believe the combination and collaboration of design, code, technology, and marketing leads
				to powerful products, impactful websites, and further innovation.
			</p>
